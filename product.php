  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/z/l/f/buds-pro-2-oneplus-original-imaghtn6pfhr9yya.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/q/6/c/buds-pro-2-oneplus-original-imaghtn6fwuf8hth.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/l/i/q/buds-pro-2-oneplus-original-imaghtn6df2rdveb.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/x/g/m/-original-imagnth53aukzbth.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/k/n/x/buds-pro-2-oneplus-original-imaghtn6dpbvkyhm.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/y/z/y/buds-pro-2-oneplus-original-imaghtn62tj9mrxp.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/q/5/h/-original-imagpehwc6n72seh.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/e/r/n/buds-pro-2-oneplus-original-imaghtn8nfjw6zvu.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/i/h/1/buds-pro-2-oneplus-original-imaghtn84yesxavy.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
...
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/x/g/m/-original-imagnth53aukzbth.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
                      ...
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/z/q/k/buds-pro-2-oneplus-original-imaghtn8tjbfqmrz.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/2/x/3/buds-pro-2-oneplus-original-imaghtn8yjzwwagx.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
...
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/q/5/h/-original-imagpehwc6n72seh.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/z/l/f/buds-pro-2-oneplus-original-imaghtn6pfhr9yya.jpeg?q=70&crop=false" alt="">
                              <p class="mb-0">Arbor Green</p>
...
https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/k/9/j/buds-pro-2-oneplus-original-imaghtn8geqzfvj7.jpeg?q=70&crop=false" alt="">
                              <p class="mb-0">Obsidian Black</p>
                          </div></div></div></div></div></div>
              
              <div class="row p-2 my-2 bg-white">
                <p class=" " style="font-weight: 100;">OnePlus Buds Pro 2 Bluetooth Headset  (Arbor Green, True Wireless)</p>
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹139.23</h5>
                  <h5 class="me-2 text-muted fw-bold text-decoration-line-through " style="">₹13999</h5>
              ...
              </div><div class="row  mt-2"><div class="col bg-white border p-3"><p class="fw-bold">Product Detail</p><p>A new version of the 169 firmware is now available for the OnePlus Buds Pro 2/2R. The latest release further optimizes the sound quality of the device.
General
Model Name
Buds Pro 2
Color
...
No
Sales Package
1 Pair of Earbud, Charging Case, Charging Cable (Type C), Safety Card, Warranty Card, 4 Ear Tips
Connectivity
Bluetooth
Headphone Design
Earbud
...
<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9df2f3f8edf1e8eefefceff8ddf2f3f8edf1e8eeb3fef2f0">[email&#160;protected]</a> 1800 102 8411
Covered in Warranty
...
<div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
  ...
  <div class="position-relative d-flex">
      ...
      <a href="cart.html"  class="stretched-link"></a>     
  </div>
</div>
