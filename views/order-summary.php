...
<div class=""> </div>
          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/z/l/f/buds-pro-2-oneplus-original-imaghtn6pfhr9yya.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">OnePlus Buds Pro 2 Bluetooth Headset  (Arbor Green, True Wireless)</div>
                                    <div class="product-detail mb-1" id="product-detail">Arbor Green</div>
              ...
              <div class="flex recommended-product mt-3">
                ...
                <div class="description">
                  ...
                  <span class="discount" id="discount">95% off</span>
                    ...
                    <span class="strike mrp" id="mrp">₹2599</span>
                    
                    <span class="selling_price" id="selling_price">₹129</span>                    </div>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            <div class="product-price-list my-3">
              ...
              <span class="data mrp me-0 td-none">₹2599</span>
            </div>
            <div class="product-price-list my-3">
            ...
            <div class="product-price-list my-3 pt-3 total">
              ...
              <span class="data selling_price">₹129</span>
            </div>
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹2469.05</span> on this order</span>
            </div>          </div>
        </div>
        ...
        <div class="col-6 footer-price">
            ...
            <span class="strike mrp ms-0 mb-1" id="mrp">&#8377;2599</span>
            <span class="selling_price" id="selling_price">&#8377;129</span>
          </div><a class="buynow-button product-page-buy col-6 btn-continue text-center" type="button" href="payment2/payment.php?price=129">
            Continue
          </a>        </div>
      </div>
