          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/832/832/kmkxbww0/speaker/tower-speaker/e/m/3/jblpartybox310in-jbl-original-imagfg4q5rs3gmyq.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">JBL Partybox 310 - 18Hrs Playtime, JBL Pro Sound, Dynamic Light Show, IPX4 Portable 240 W Bluetooth Soundbar  (Black, Stereo Channel)</div>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            ...
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹1899.05</span> on this order</span>
            </div>          </div>
        </div>
