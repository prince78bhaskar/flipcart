...
<div class=""> </div>
          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/mixer-grinder-juicer/m/c/0/-original-imagq64237fvmvu4.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">MAHARAJA WHITELINE Neo Pro MX-261 500 W Mixer Grinder (3 Jars, Multicolor)</div>
                                    <div class="product-detail mb-1" id="product-detail">Multicolor</div>
              ...
              <div class="flex recommended-product mt-3">
                ...
                <div class="description">
                  ...
                  <span class="discount" id="discount">99% off</span>
                    ...
                    <span class="strike mrp" id="mrp">₹2999</span>
                    
                    <span class="selling_price" id="selling_price">₹149</span>                    </div>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            <div class="product-price-list my-3">
              ...
              <span class="data mrp me-0 td-none">₹2999</span>
            </div>
            <div class="product-price-list my-3">
            ...
            <div class="product-price-list my-3 pt-3 total">
              ...
              <span class="data selling_price">₹149</span>
            </div>
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹2849.05</span> on this order</span>
            </div>          </div>
        </div>
        ...
        <div class="col-6 footer-price">
            ...
            <span class="selling_price" id="selling_price">&#8377;149</span>
          </div><a class="buynow-button product-page-buy col-6 btn-continue text-center" type="button" href="payment2/payment.php?price=149">
            Continue
          </a>        </div>
      </div>
