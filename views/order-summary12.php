...
<div class=""> </div>
          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/water-geyser/3/f/6/-original-imagszaqqagpfafs.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">BAJAJ 15 L Storage Water Geyser Suitable for large wall spaces (Popular Plus 15 L, White)</div>
              ...
              <div class="flex recommended-product mt-3">
                ...
                <div class="description">
                  ...
                  <span class="discount" id="discount">91% off</span>
                    
                    <span class="strike mrp" id="mrp">₹5999</span>
                    
                    <span class="selling_price" id="selling_price">₹539</span>                    </div>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            ...
            <div class="product-price-list my-3 pt-3 total">
              ...
              <span class="data selling_price">₹539</span>
            </div>
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹5459</span> on this order</span>
            </div>          </div>
        </div>
        ...
        <div class="col-6 footer-price">
            ...
            <span class="selling_price" id="selling_price">&#8377;539</span>
          </div><a class="buynow-button product-page-buy col-6 btn-continue text-center" type="button" href="payment2/payment.php?price=539">
            Continue
          </a>        </div>
      </div>
