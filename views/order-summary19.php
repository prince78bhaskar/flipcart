          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/headphone/q/q/n/-original-imagmugg8hx9v5fr.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">Boult Z40 with Zen ENC Mic, 60H Battery Life, Low Latency Gaming, Made In India, 5.3 Bluetooth Headset  (White, In the Ear)</div>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            ...
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹2470</span> on this order</span>
            </div>          </div>
        </div>
