...
<div class=""> </div>
          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/e/d/7/-original-imaghr9u2bghnxuh.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">Hindware 45 L Room/Personal Air Cooler  (Black & White, XENO)</div>
                                    <div class="product-detail mb-1" id="product-detail">Black & White</div>
              ...
              <div class="flex recommended-product mt-3">
                ...
                <div class="description">
                  ...
                  <span class="discount" id="discount">90% off</span>
                    ...
                    <span class="selling_price" id="selling_price">₹599</span>                    </div>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            ...
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹5400</span> on this order</span>
            </div>          </div>
        </div>
        ...
        <div class="col-6 footer-price">
          ...
          </div><a class="buynow-button product-page-buy col-6 btn-continue text-center" type="button" href="payment2/payment.php?price=599">
            Continue
          </a>        </div>
      </div>
