...
<div class=""> </div>
          ...
          <ul class="list-group list-group-flush" id="deals">
            <li class="list-group-item px-0" data-timer="2000">
              <div class="flex recommended-product">
                ...
                <img src="https://rukminim2.flixcart.com/image/832/832/l5ld8y80/smartwatch/r/q/t/-original-imagg8dksgct9hxg.jpeg?q=70&crop=false" id="item_image" />
                                <div class="description">
                                    <div class="product-title mb-1" id="product-title">Noise Colorfit Icon 2 1.8'' Display with Bluetooth Calling, AI Voice Assistant Smartwatch  (Black Strap, Regular)</div>
              ...
              <div class="flex recommended-product mt-3">
                ...
                <div class="description">
                  ...
                  <span class="discount" id="discount">95% off</span>
                    ...
                    <span class="strike mrp" id="mrp">₹1299</span>
                    
                    <span class="selling_price" id="selling_price">₹65</span>                    </div>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="card px-3 py-4 mb-2" id="price-detail">
          ...
          <div class="price-detail-div mt-2">
            <div class="product-price-list my-3">
              ...
              <span class="data mrp me-0 td-none">₹1299</span>
            </div>
            <div class="product-price-list my-3">
              <span class="title">Discount</span>
              <span class="data discount-amt text-success">-₹1234.05</span>
            </div>
            <div class="product-price-list my-3">
            ...
            <div class="product-price-list my-3 pt-3 total">
              ...
              <span class="data selling_price">₹65</span>
            </div>
            <div class="product-price-list mt-3 pt-3 saved-div">
              <span class="text-success">You will save <span class="discount-amt">₹1234.05</span> on this order</span>
            </div>          </div>
        </div>
        ...
        <div class="col-6 footer-price">
            ...
            <span class="strike mrp ms-0 mb-1" id="mrp">&#8377;1299</span>
            <span class="selling_price" id="selling_price">&#8377;65</span>
          </div><a class="buynow-button product-page-buy col-6 btn-continue text-center" type="button" href="payment2/payment.php?price=65">
            Continue
          </a>        </div>
      </div>
