  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/mobile-tablet-speaker/g/v/r/ws-1300-sound-box-mini-home-theatre-wireless-bass-15w-bluetooth-original-imagkyzshzdvu2j7.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/mobile-tablet-speaker/l/o/m/best-buy-ws-1300-loud-stereo-sound-rich-bass-portable-wireless-original-imagjtdkpdchx5c4.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/mobile-tablet-speaker/m/f/m/best-buy-ws-1300-loud-stereo-sound-rich-bass-portable-wireless-original-imagjtdkf9jmhruk.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/mobile-tablet-speaker/6/a/x/best-buy-ws-1300-loud-stereo-sound-rich-bass-portable-wireless-original-imagjtdkvvff9gj2.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/mobile-tablet-speaker/g/v/r/ws-1300-sound-box-mini-home-theatre-wireless-bass-15w-bluetooth-original-imagkyzshzdvu2j7.jpeg?q=70&crop=false" alt="">
                              <p class="mb-0">BLACK </p>
                          </div></div></div></div></div></div>
              
              <div class="row p-2 my-2 bg-white">
                <p class=" " style="font-weight: 100;">Musify Karaoke Mini Home Theatre { Free MIC } 15 W Bluetooth Speaker 15 W Bluetooth Speaker  (Black, Stereo Channel)</p>
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹199.16</h5>
                  <h5 class="me-2 text-muted fw-bold text-decoration-line-through " style="">₹1999</h5>
              ...
              </div><div class="row  mt-2"><div class="col bg-white border p-3"><p class="fw-bold">Product Detail</p><p>General
Sales Package
Speaker, MIC, USB CHARGING CABLE
Model Number
WS-1300 Sound Box Mini home theatre wireless bass 15W Bluetooth Party Speaker
Model Name
Karaoke Mini Home Theatre { Free MIC } 15 W Bluetooth Speaker
Type
...
IOS
Compatible Devices
Mobiles, Laptop, PC, Tablet, TV
Connector Type
AUX, Micro USB
Charging Time
2 hr
Battery
Lithium ion, Use Time 8 hr
Battery Capacity
1200 mAh
USB Ports
1 USB Ports
...
Extra Bass HD sound and is perfect for getting the party started with some danceable jams, Provides extended playback, enables you to stream music for up to 6 hours on a full charge
Other Details
Chassis Material
ABS plastic Chassis
Technology Used
...
Charge your device completely before first use
Other Features
The powerful rechargeable battery could provide more than 8 hours of non-stop music playing at its largest volume., The color of light will change with the beat of the music to make all of you feel the cheerful atmosphere from disco when karaoke.
Dimensions
Cable Length
1 m
Width
...
<div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
  ...
  <div class="position-relative d-flex">
      ...
      <a href="cart16.html"  class="stretched-link"></a>     
  </div>
</div>
