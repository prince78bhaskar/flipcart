  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7x9zgrzbz.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7zzxgrfhe.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7uvrkykv9.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7p8fwk7pt.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7fxjup2e6.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7kz9baxxt.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7cutvhngq.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7fnqkvgbh.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="https://rukminim2.flixcart.com/image/832/832/kfcv6vk0/power-bank/r/f/5/power-bank-20000-plm18zm-mi-original-imafvtc7x9zgrzbz.jpeg?q=70&crop=false" alt="">
                              <p class="mb-0">Black</p>
                          </div></div></div></div></div></div>
              
              <div class="row p-2 my-2 bg-white">
                <p class=" " style="font-weight: 100;">Mi 20000 mAh 18 W Power Bank  (Black, Lithium Polymer, Fast Charging for Mobile)</p>
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹139.43</h5>
                  <h5 class="me-2 text-muted fw-bold text-decoration-line-through " style="">₹2199</h5>
              ...
              </div><div class="row  mt-2"><div class="col bg-white border p-3"><p class="fw-bold">Product Detail</p><p>Don’t let your devices run out of battery while you’re away with this Mi power bank. Thanks to its 18 W fast charge support, this power bank helps you charge your devices quickly and efficiently. It also helps you charge almost all types of devices, such as smartphones, fitness bands and Mi wireless earphones and tablets.
Charges Multiple Devices
This 20000 mAh power bank lets you charge three devices at a time. It also charges quickly with its 18 W fast charge support.
Dual Input With Type-C
It can be charged through a Type-C port or micro USB port.
Power Delivery
The Type-C charging output helps charge multiple devices efficiently.
Powerful
With its 5V/2.4A, 9V/2A and 12V/1.5A charging compatibility, this power bank can efficiently charge all types of devices, including smartphones, tablets and fitness bands.
Smart Power Management
You can switch the power bank into 2-hour low charging mode by double pressing the power button. This will help you charge low power devices, like Mi Band, Mi wireless earphones and more.
Battery
It features a lithium polymer battery that ensures safety, enhances charging conversion rates and maintains the discharging voltage.
12-layer Circuit Protection
Its 12-layer protective design keeps your devices protected from overheating and short circuits.
General
Sales Package
1 Power Bank, 1 USB Cable and 1 User Manual
Model Name
Power Bank
Suitable Device
Mobile
...
Yes
Power Supply
USB-C: 5 V/3 A, 9 V/2 A, 12 V/1.5 A, Micro-USB: 5 V/2 A, 9 V/2 A, 12 V/1.5 A
Output Power
USB-A: 5 V/2.4 A, 9 V/2 A, 12 V/1.5 A, USB-C: 5 V/3 A, 9 V/2 A, 12 V/1.5 A, Triple Port: 5 V/3.6 A
Other Features
Power Delivery, Smart Power Management
Width
72.2 mm
Height
150.6 mm
...
Physical Damages, Wear and Tear
Domestic Warranty
6 Months</p></div></div>
...
<div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
  ...
  <div class="position-relative d-flex">
      ...
      <a href="cart8.html"  class="stretched-link"></a>     
  </div>
</div>
