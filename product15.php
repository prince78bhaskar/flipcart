  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/c/1/orion-boat-original-imagtvgsvga2rrmf.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/9/c/orion-boat-original-imagtvgswstnkpwh.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/h/l/h/orion-boat-original-imagtvgsyvh4gyet.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/n/m/e/orion-boat-original-imagtvgsmkcyjkhj.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="
https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/i/l/o/orion-boat-original-imagtvgsdhjc9dhz.jpeg?q=70&crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="https://rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/c/1/orion-boat-original-imagtvgsvga2rrmf.jpeg?q=70&crop=false" alt="">
                              <p class="mb-0">BLACK </p>
                          </div></div></div></div></div></div>
              
              <div class="row p-2 my-2 bg-white">
                <p class=" " style="font-weight: 100;">boAt Aavante Bar Orion with Multiple Connectivity Ports, EQ Modes 160 W Bluetooth Soundbar  (Pitch Black, 2.1 Channel)</p>
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹279.32</h5>
                  <h5 class="me-2 text-muted fw-bold text-decoration-line-through " style="">₹8499</h5>
...
Sales Package
Soundbar, cable, manual
Model Number
Orion
Model Name
Aavante Bar Orion with Multiple Connectivity Ports, EQ Modes
Type
Soundbar
Bluetooth
Yes
...
<div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
  ...
  <div class="position-relative d-flex">
      ...
      <a href="cart15.html"  class="stretched-link"></a>     
  </div>
</div>
